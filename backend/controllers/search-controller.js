...
export async function searchPerson(req, res) {
    ...
    try {
        ...
        console.log("Error in searchPersonController: ", error.message);
...
export async function searchMovie(req, res) {
    ...
    try {
        ...
        console.log("Error in searchMovieController: ", error.message);
        res.status(500).json({success: false, message: "Server Error"});
    }
}
...
export async function searchShow(req, res) {
    ...
    try {
        ...
        console.log("Error in searchShowController: ", error.message);
        res.status(500).json({success: false, message: "Server Error"});
    }
}
